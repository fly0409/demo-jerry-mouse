package com.iisi.context;


import com.iisi.context.connector.HttpConnector;
...
public class HttpServerStart implements AutoCloseable{
    final Logger logger = LoggerFactory.getLogger(getClass());

    public static void main(String[] args) throws IOException {
        String host = "0.0.0.0";
        int port = 8080;
        HttpServerStart connector = new HttpServerStart(host, port);
    }
    ...
    public HttpServerStart(String host, int port) throws IOException {
        this.host = host;
        this.port = port;
